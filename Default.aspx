...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    &nbsp;--%>
        ...
        <ul>
            ...
            <li style="width:800px"><asp:Button ID="BtnHistory" Font-Bold="True" Font-Size="XX-Large" style=" font-size:larger; background-image:url('image/history.png'); background-size:cover; cursor:hand;" Width="200px" Height="200px"  runat="server" Text="History" OnClick="BtnWithdraw_Click" /></li>
